            ...
            tablaClientes = $("#clientes").DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == null) {
                                return `<img src="../app/clientes/images/generic.jpg" alt="Imagen" class="rounded-circle" width="60" height="60">`;
                            } else {
                                return `<img src="../app/clientes/images/${data}" alt="Imagen" class="rounded-circle" width="60" height="60">`;
                            }
                        }
                    },
                    {
