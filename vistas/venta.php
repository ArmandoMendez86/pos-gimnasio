            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="table-responsive mt-4">
                        <table class="table table-hover m-b-0" id="ventaProductos" style="width:100%">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td style="color: green;font-size:1.5rem !important;font-weight:700;text-align:center;" id="sumaTotal"></td>
                                </tr>
                            </tfoot>
                        </table>
                        ...
                        <div class="text-center">
                            <button class="btn btn-danger" style="border-radius: .5rem;" id="realizarVenta">Pagar</button>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <form id="formServiciosVentas">
                        ...
                        <div class="form-group">
                            <label for="nombre">Tipo de Membresía</label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" style="width: 100%;" id="couchSelect">
                        ...
                        <div class="text-center">
                            <button type="button" class="btn btn-primary" id="ventaServicio">Realizar venta</button>
                        </div>
                    </form>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                    ...
                    <form id="formRegalias">
                        <div class="form-group">
                            <label for="productoReg">Producto</label>
                            <select class="form-control productoReg" style="width: 100%" id="productoReg"></select>
                        </div>
                        <div class="form-group">
                            <label for="cantidadReg">Cantidad</label>
                            <input type="number" class="form-control" style="width: 100%" id="cantidadReg" min="1">
                        </div>
                        <div class="form-group">
                            <label for="cliente">Persona</label>
                            <input class="form-control" style="width: 100%" type="text" id="personaReg" list="opciones">
                            <datalist id="opciones">
                                <option value="Armando">
                                <option value="Rouss">
                                <option value="Chava">
                                <option value="Oswaldo">
                                <option value="Dunia">
                        ...
                        <div class="text-center">
                            <button type="button" class="btn btn-primary" id="registrarReg">Registrar</button>
                        </div>
                    </form>
        ...
        $(document).ready(function() {
            catalogoProductos = $("#productos").DataTable({
                ...
                columns: [{
                    ...
                    {
                        defaultContent: "<div class='text-center'><button class='agregarProducto btn btn-primary'><i class='fa fa-plus' aria-hidden='true'></i></button></div>",
                    },
                ],
                columnDefs: [{
                        targets: [0, 1, 4, 5, 6],
            ...
            $(document).on("click", ".agregarProducto", function() {
                ...
                if (filasConValor.length > 0) {
                    ...
                    fila.append($("<td>").html("<i class='fa fa-trash removerProducto fa-2x' aria-hidden='true'></i>"));
            ...
            $("#ventaServicio").click(function(e) {
                ...
                let couchSelect = $("#couchSelect").val();
                let termina = '';
                let fechaPersonalizado = '';
                let fechaFinPersonalizado = '';

                if (couchSelect !== '') {
                    fechaPersonalizado = formatDateTime(new Date());
                }
            ...
            $("#registrarReg").click(function() {
                ...
                let p_s = $("#productoReg").val();
                let cantidad = $("#cantidadReg").val();
                let persona = $("#personaReg").val();
                let fecha = fechaActual;
                let idempleado = <?php echo $_SESSION['id'] ?>;
                ...
                $('.productoReg').val(null).trigger('change');
                $("#cantidadReg").val(0);
                $("#personaReg").val('');
